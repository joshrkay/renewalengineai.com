    ...
    <main className="bg-black text-white min-h-screen pt-32 pb-24">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-16 max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl font-black mb-6">AI Mastermind & Community</h1>
          <p className="text-xl text-neutral-300 mb-8">
            The course ends. The work doesn't. The Mastermind is where agency owners keep sharpening
            their AI operating system month after month, together.
          </p>
          <div className="flex items-center gap-4">
            <span className="text-3xl font-black text-white">$97 – $197 / month</span>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-10 text-center">
          ...
          <p className="text-neutral-300 mb-8 max-w-2xl mx-auto">
            Best fit for agency owners who have completed at least one of the DIY courses and want
            to stay in a room with people doing the same work. Not for passive consumption —
            mastermind members show up.
          </p>
          <a
            href="/book.html"
