    ...
    <main className="bg-black text-white min-h-screen pt-32 pb-24">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-16 max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl font-black mb-6">Agency Team Licenses</h1>
          <p className="text-xl text-neutral-300 mb-8">
            When one person learns AI, one person benefits. When your whole team learns AI, your
            whole agency gets faster. Team licenses give every producer and CSR access to the
            full course library at a price that makes sense for agencies with 3 to 50 seats.
          </p>
          <div className="flex items-center gap-4">
            <span className="text-3xl font-black text-white">Custom pricing</span>
            <span className="text-neutral-400 text-sm">Based on seat count</span>
          </div>
        </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-10 text-center">
          <h3 className="text-3xl font-black mb-4">Tell us about your team</h3>
          <p className="text-neutral-300 mb-8 max-w-2xl mx-auto">
            Team licenses are priced on seat count, agency size, and whether you want live
            onboarding. Book a 15-minute call and we'll put together a proposal within a day.
          </p>
          <a
            href="/book.html"
