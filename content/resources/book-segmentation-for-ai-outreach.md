...
**2. Household depth.** Monoline vs. multi-line is the retention cliff dimension: books with policies-per-household above 2.0 retain at 95%+ while the average sits near 1.4. Monoline households get cross-sell-aware sequences (the [seven triggers](/resources/cross-sell-triggers-for-independent-agencies) do the targeting); deep households get protection-review framing instead, because pitching a fourth policy to a four-policy household reads as noise.
