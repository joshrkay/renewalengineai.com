...
term: "Endorsement"
slug: "endorsement"
shortDefinition: "An endorsement is a formal amendment to an existing insurance policy that adds, removes, or changes coverage mid-term — the mechanism behind most routine service work in an agency."
...
1. **Classify** the inbound request and extract the specifics
2. **Draft** the carrier submission and the client confirmation
3. **Track** the request until the carrier confirms issuance
