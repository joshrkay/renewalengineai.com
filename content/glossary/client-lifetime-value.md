---
term: "Client Lifetime Value (LTV)"
slug: "client-lifetime-value"
shortDefinition: "Client lifetime value is the total commission an agency expects to earn from a client across the entire relationship — annual commission multiplied by expected tenure, which is itself set by retention rate."
category: "Metrics"
aliases:
  - "LTV"
